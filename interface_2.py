...
class Ui_MainWindow(object):
    ...
    def import_csv(self):
        ...
        print("nombres de joueurs " + str(num_joueurs))
        ...
        print('nombre_strat', nombre_strat)
        ...
        def genMatGains(data, strategies):
            ...
            return gains
        print('gainmat',genMatGains(filedata,nombre_strat))
        matGains = genMatGains(filedata,nombre_strat)

    def equilibre_nashMixte(self):
        global matGains
        global final_nash
        ...
        if (len(matGains[0]==3) & len(matGains[1]==3)):
    ...
    def setupUi(self, MainWindow):
        ...
        self.btn_import.clicked.connect(self.equilibre_nashMixte)
        '''self.btn_gameinfo.clicked.connect(self.cherche_val)'''
